      ...
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="max-w-2xl w-full">
          ...
          <div className="flex flex-col items-center space-y-8">
            ...
            {/* ElevenLabs Widget Container - Centered as Primary Focus */}
            <div className="bg-gray-800 border-2 border-blue-500 rounded-2xl p-12 w-full shadow-2xl shadow-blue-500/20">
              {!isWidgetLoaded ? (
